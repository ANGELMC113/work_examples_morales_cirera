# Versión 1: secuencial con Python
...
with open(input_file, newline='') as csvfile:
    ...
    for row in reader:
        ...
        t=d.get((row['actor'],row['director']),(row['actorName'],
            row['directorName'],0,0,rating,rating))
        d[(row['actor'],row['director'])] = (row['actorName'], row['directorName'],t[2]+1,
            t[3]+rating, min(rating,t[4]), max(rating,t[5]))
